...
public class Wire implements Drawable, Movable, ObservableValueReader {
    ...
    private java.awt.Color customColor;
    ...
    public Wire(Wire proto) {
        ...
        this.customColor = proto.customColor;
    }
    ...
    public void drawTo(Graphic graphic, Style highLight) {
        ...
        if (style == null) {
            ...
            if (value == null && c != null)
                style = style.deriveColor(c);
            else if (value != null && customColor != null)
                style = Style.getWireStyle(new Value(value, customColor));
        }
     ...
     */
    public Wire setColor(java.awt.Color color) {
        this.color = color;
        return this;
    }

    /**
     * Sets the custom color of this wire
     *
     * @param color the color
     * @return this for chained calls
     */
    public Wire setCustomColor(java.awt.Color color) {
        this.customColor = color;
        return this;
    }

    /**
     * @return the color of this wire
     */
    ...
    /**
     * @return the custom color of this wire
     */
