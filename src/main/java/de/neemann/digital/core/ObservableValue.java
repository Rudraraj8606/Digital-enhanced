...
public class ObservableValue extends Observable implements PinDescription {
     ...
     */
    public ObservableValue setColor(java.awt.Color color) {
        this.color = color;
        return this;
    }
    ...
    /**
     * Returns the common color of the given values.
     *
     * @param values the values
     * @return the common color or null if no common color exists
     */
    public static java.awt.Color getCommonColor(Iterable<ObservableValue> values) {
        java.awt.Color common = null;
