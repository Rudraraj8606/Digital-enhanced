...
public class Value {
    ...
    Value(ObservableValue observableValue) {
        ...
        this.mask = Bits.mask(bits);
        this.color = observableValue.getColor();
    }

    /**
     * Creates a new value from an old one with a different color.
     *
     * @param value the old value
     * @param color the new color
     */
    public Value(Value value, java.awt.Color color) {
        this.value = value.value;
        this.highZ = value.highZ;
